...
export function TransactionStatus({ state, hash, confirmedText = 'Position recorded on-chain.', detail }: { state: TransactionState; hash?: `0x${string}`; confirmedText?: string; detail?: string }) {
