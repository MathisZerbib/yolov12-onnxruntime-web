...
export const ROOM_MARKERS: readonly LiveMarker[] = Object.freeze([
  ...
  { id: "nyc",    name: "New York", locationLabel: "Times Square", location: [40.71, -74.01],  href: "/room/nyc",   streamUrl: "https://wzmedia.dot.ca.gov/D11/C304_SB_282_at_4th_and_Alameda_Coronado.stream/chunklist_w200261284.m3u8" },
  { id: "london", name: "London", locationLabel: "Oxford St",     location: [51.51, -0.13],    href: "/room/london", streamUrl: "https://wzmedia.dot.ca.gov/D11/C033_SB_163_JSO_Clairemont_Mesa.stream/chunklist_w651583779.m3u8" },
])
